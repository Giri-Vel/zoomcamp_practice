...
def run_register_model(data_path: str, top_n: int):
    ...
    # Evaluate the top_n models and select the one with the lowest test RMSE
    for run in runs:
    ...
    if best_run:
        ...
        print(f"Best model with test RMSE of {best_rmse} has been registered.")
    else:
        print("No model selected for registration.")
